...
@section('navheader')
    <div class="container-fluid">
        <div class="navbar-header">
            <a class="navbar-brand" href="#">Nuevo Perro</a>
        </div>
    </div>
@stop
@section('content')
    <div class="card">
        <div class="content">
            ...
            @foreach($abilities as $id => $ability)
                ...
                <div class="checkbox">
                    <label>
                        {!! Form::checkbox("abilities[]", $id) !!} {{$ability}}
                    </label>
                </div>
                </div>
                @if ($id%3==0)
            ...
            @endforeach
                ...
                {{ Form::submit('Guardar perro', array('class' => 'btn btn-primary')) }}
